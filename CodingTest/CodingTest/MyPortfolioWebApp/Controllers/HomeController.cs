...
namespace MyPortfolioWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> About()
        {
            ...
            // DB에서 데이터를 불러온 뒤 About, Skill 객체에 데이터를 담아서 뷰로 넘겨줌
        ...
        {
            if (ModelState.IsValid) // Model에 들어간 4개 값이 제대로 들어갔으면
            {
                try
                {
                    var smtpClient = new SmtpClient("smtp.gmail.com") // Gmail을 사용하면
                    {
                        ...
                        Credentials = new NetworkCredential("이메일", "비밀번호노출"),
                        EnableSsl = true,
                    };
                    ...
                    mailMessage.To.Add("이메일"); // 받을 메일 주소
