...
INSERT INTO `About` VALUES (1,'현재 IoT, WPF(C#), AI(Python), Spring Boot(Java)를 가르치고 있는 전문강사입니다','Iot/WPF/Web/Python 개발자','1976-11-21 00:00:00.000000','www.github.com/hugoMGSung','+82 10 6683 7773','부산광역시 남구 신선로 365','석사학위','personar95@naver.com','프리랜서 강사','2004년 웹 개발로 시작하여 앱 개발, 스마트팩토리, 스마트쉽 등 여러방면의 경험을 가지고 있는 21년차 개발자입니다','/img/profile-img.jpg');
